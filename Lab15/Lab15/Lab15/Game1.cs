...
namespace Lab15
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            for (int counter = 0; counter < NUM_TEXTURES; counter++) {
                textures.Add(Content.Load<Texture2D>("teddybear"+counter));
            }
            ...
            for (int counter = 0; counter < textures.Count; counter++) {
                drawTextures.Add(textures[counter]);
                drawRectangles.Add(GetRandomDrawRectangle(drawTextures[counter]));
            }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.A) && drawTextures.Count < MAX_TEXTURES) {
                drawTextures.Add(textures[rand.Next(3)]);
                drawRectangles.Add(GetRandomDrawRectangle(drawTextures[drawTextures.Count - 1]));
            }
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.B) && drawTextures.Count > 0){
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin(); 
            for (int counter = 0; counter < drawTextures.Count; counter++) {
                spriteBatch.Draw(drawTextures[counter], drawRectangles[counter], Color.White);
            }
            spriteBatch.End();
        ...
        private Rectangle GetRandomDrawRectangle(Texture2D sprite)
        {
            ...
            // window
            return new Rectangle(rand.Next(WINDOW_WIDTH - sprite.Width) + 1,
                                 rand.Next(WINDOW_HEIGHT - sprite.Height) + 1,
                                 sprite.Width, 
                                 sprite.Height);
        }
    }
